...
export function TimerGui(): React.Element {
	...
	React.createElement("ScreenGui", {
		...
		// Was 0 (the serialized original) — that ties with the full-screen
		// Garage ScreenGui (also 0), which rendered OVER the shop-phase
		...
		React.createElement("TextLabel", {
			...
			OpenTypeFeatures: "",
			Position: new UDim2(0.025, 0, 0.085, 0),
			RichText: false,
			Rotation: 0,
			Selectable: false,
			SelectionBehaviorDown: Enum.SelectionBehavior.Escape,
