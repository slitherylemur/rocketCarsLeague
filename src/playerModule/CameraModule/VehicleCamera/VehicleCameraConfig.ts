// Original: StarterPlayer/StarterPlayerScripts/PlayerModule/CameraModule/VehicleCamera/VehicleCameraConfig (ModuleScript)

const VEHICLE_CAMERA_CONFIG = {
